        ...
        <section class="service-print">
            <header class="header">
                ...
                <div class="info">
                    ...
                    <span class="data"><b>Entrega/devolución:</b> {{ \Date::createFromFormat('Y-m-d', $service->date_start)->format('d-m-Y') }} - {{ \Date::createFromFormat('Y-m-d', $service->date_end)->format('d-m-Y') }}</span>
                </div>
                <!-- /.info -->
            </header>
            <!-- /.header -->
