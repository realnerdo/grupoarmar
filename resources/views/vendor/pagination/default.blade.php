@if ($paginator->hasPages())
    <ul class="list">
        ...
        @else
            <li class="item"><a href="{{ $paginator->previousPageUrl() }}" rel="prev" class="link">&laquo;</a></li>
        @endif
        ...
        @if ($paginator->hasMorePages())
            <li class="item"><a href="{{ $paginator->nextPageUrl() }}" rel="next" class="link">&raquo;</a></li>
        @else
